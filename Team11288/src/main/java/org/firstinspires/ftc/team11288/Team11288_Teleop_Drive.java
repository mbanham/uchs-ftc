...
@TeleOp(name="Team11288_Teleop_Drive", group="Teleop")
@Disabled
public class Team11288_Teleop_Drive extends OpMode{
  ...
  //  private DcMotor motorFrontRight;
   // private DcMotor motorFrontLeft;
    ...
    private static final double START_ARM_SERVO_R = 0.2;
    ...
    public void loop() {
       // teamUtils.printColorDistance(sensorColor, sensorDistance);
        ...
        //TODO: Use gamepad2 left & right trigger!=0.0 to raise and lower the claw arm (leftArm, rightArm)
    //copy lines for claw above and adapt to  claw arm

        if (gamepad2.right_trigger > 0.5) {
            clawArmOffsetR -= CLAW_SPEED;
        ...
        clawArmOffsetR = Range.clip(clawArmOffsetR, 0.0, 0.3);
