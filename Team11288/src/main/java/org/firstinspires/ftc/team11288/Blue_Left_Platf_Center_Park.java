       ...
       // teamUtils.InitExtraSensors(hardwareMap);
        ...
        while (opModeIsActive()) {
            if (!stepsCompleted) {
                ...
                teamUtils.drivebyDistance(0.85, 0, 27);//drive to base plat
                ...
                teamUtils.drivebyDistance(0.0, -0.85, 30);//drive towards bridge
                teamUtils.drivebyDistance(0.85, 0, 43);//drive towards center
                teamUtils.drivebyDistance(0.0, 0.85, 31);//drive towards wall
                teamUtils.drivebyDistance(-0.85, 0, 25);//push foundation
                teamUtils.drivebyDistance(0.0, -0.85, 22);//drive up to park
                teamUtils.drivebyDistance(-0.85, 0.0, 6);//drive away from center
