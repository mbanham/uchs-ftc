package org.firstinspires.ftc.teamc11288;
...
@Autonomous(name = "Depot_No_Land", group = "Linear Opmode")
//@Disabled                            // Comment this out to add to the opmode list

public class Depot_No_Land extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if(doneWithCamera && !doneKnockingGold) {
                ...
                if(locationOfGold == 0) {  //center
                    ...
                    teamUtils.driveFixedDistance(1,22, false);
                    ...
                    teamUtils.driveFixedDistance(1,23.4, false);
                    doneKnockingGold=true;
                    //drop Marker
            ...
            if(doneWithCamera && doneKnockingGold  && !doneWithDrop) {
